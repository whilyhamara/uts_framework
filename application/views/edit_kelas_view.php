				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<nav class="navbar navbar-default" role="navigation">
							<div class="container-fluid">
								...
								<button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
									...
									<a class="navbar-brand" href="<?php echo site_url('pegawai') ?>">Whilyham</a>
								</div>
					...
					<?php echo form_open_multipart('kelas/update/'.$this->uri->segment(3)); ?>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="nama" name="nama" placeholder="Edit Nama Anda" value="<?php echo $kelas[0]->nama ?>">
									<br>
								</div>
