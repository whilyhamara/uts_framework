				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse navbar-ex1-collapse">
									<ul class="nav navbar-nav">
										<li class="active"><a href="<?php echo site_url('kelas') ?>">Input Kelas</a></li>
									</ul>
					...
					<?php echo form_open_multipart('siswa/create'); ?>
								...
								<div class="form-group">
									...
									<input type="date" class="form-control" id="tanggalLahir" name="tanggal_lahir" placeholder="Tanggal Lahir">
									<br>
									<label for="">Kelas</label>
									
									<?php 
									echo "<select class='form-control' name='fk_kelas'>";
